...
public class NotificationManagerAndroidService : INotificationManagerService
{
    ...
    public static NotificationManagerAndroidService Instance { get; private set; }
    
     public NotificationManagerAndroidService()
    {
        if (Instance == null)
        {
    ...
    public void Show(string title, string message)
    {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(Platform.AppContext, channelId)
            ...
            .SetLargeIcon(BitmapFactory.DecodeResource(Platform.AppContext.Resources, Resource.Drawable.abc_btn_check_material))
